...
const Hero = () => {
  ...
  return (
    <section className="w-full px-6 py-24 bg-white" style={{ width: '100%' }}>
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center gap-12">
        {/* Left Side */}
        <div className="flex-1">
          <h1 className="font-urbanist font-semibold text-[48px] md:text-[72px] leading-[60px] md:leading-[90px] tracking-[-0.02em] underline decoration-solid decoration-0 text-[#111827]">
            Connect with Nearby Top-rated Professional <span className="text-blue-700">{professions[index]}</span>
          </h1>
